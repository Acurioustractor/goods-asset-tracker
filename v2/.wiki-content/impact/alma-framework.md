...
|---|---|
| Authority | Who gets to decide what this data means and where it goes? |
| Evidence | Is this a story, observation, survey, usage log, invoice or measurement? |
| Harm risk | Could sharing this cause shame, conflict, extraction or other harm? |
| Capability | Are we ready to act on what this tells us? |
| Option value | Does this open a new path, design change or partnership? |
| Community value return | Does value flow back to the people or place the evidence came from? |

## Why not centre SROI

SROI can be useful for some funders, but it is not the right centre for Goods right now.
...
- A bed-delivery interview is story evidence. Authority stays with the storyteller.
- A QR check-in is product evidence. It needs to be simple and useful to the person scanning it.
- A washing-machine usage log is measurement evidence. It should not be treated as community consent by itself.
- A partner debrief is operational evidence. It can reveal whether production, delivery or procurement is the current constraint.

## What needs work

- Tie each metric back to the theory of change.
- Keep current and proposed metrics separate.
- Decide which evidence is for community reporting, funder reporting and internal operating decisions.
- Avoid using Indigenous data sovereignty language unless the process behind it is real.
