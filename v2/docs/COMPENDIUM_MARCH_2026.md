...
> Previous version: COMPENDIUM_JANUARY_2026.md
...
**Prevention point:** A washing machine interrupts the cascade. Clean bedding breaks the scabies cycle.
...
| Nov 2022 | Goods project kicks off (advisory: Alison Page, Corey Tutt, Nina Fitzgerald) |
...
| Metric | Value | Source |
|--------|-------|--------|
| Total assets tracked | 389 | Asset Register |
| Communities engaged | 8+ | Deployment records |
| Lives directly impacted | 1,000+ | Est. 2.5–4 people per household |
| Community feedback recorded | 500+ minutes | Internal tracking |
| Plastic diverted from landfill | 9,225kg+ | 25kg per bed × 369 |
| Verified storytellers | 15+ | Empathy Ledger v2 |
| Video testimonials | 9 | Descript library |
| Advisory board members | 13 | See Advisory Board section |
| Trade revenue (actual) | ~$50,000 | Xero |
| Outstanding receivables | ~$498,750 | Xero (Centrecorp, PICC, Homeland School) |
...
| Design life | 10+ years (vs 1–2 years standard in remote) |
...
## Production Facility (~$100K Invested)

### Container System

**Container #1: Shredding & Collection**
- Plastic shredder + community collection point
- Fills 200 tubs of processed plastic
- **Stays in community** between production runs (ongoing collection)

**Container #2: Production**
- Hydraulic press (180°C) + computer-controlled router
- Moulds for beds, washing machines, AND fridges (same facility, different moulds)
- Builds 200 beds from 200 tubs of plastic

### Process
1. Plastic collection (community members collect bottle lids/waste)
2. Shredding (processed into raw material)
3. Pressing (shredded plastic → baking trays → heated at 180°C → sheets)
4. Cooling (sheets cool overnight)
5. Cutting (computer-controlled router cuts components)
6. Assembly (5 minutes, no tools)

### Circuit Deployment Model
- Deploy to community for ~2 months → produce ~30 beds/week → move to next community
- Shredding container stays; production container travels
- **2026 planned circuit:** Alice Springs → Tennant Creek → Katherine → Darwin
...
**Oonchiumpa Consultancy** (Alice Springs/Mbantua)
- 100% Aboriginal owned and operated
- Key contacts: Kristy Bloomfield (Director), Tanya Turner (Manager), Karen Liddle (Board Chair), Fred Campbell (Youth Case Worker)
- Named after Central Australian corkwood tree (resilience, nourishment, connection to country)
- Two years co-designing products "around the fire"
- Planning production facility in Alice Springs
...
- Founded by Norman Frank Jupurrurla and Dr. Simon Quilty (CEO, 20+ years NT health)
- Housing advocacy, demonstration home partnership
...
|------|-------------|-------|------|
| Kristy Bloomfield | Oonchiumpa | kristy.bloomfield@oonchiumpa.com.au | Cultural Lead |
| Nicholas Marchesi OAM | ACT | nicholas@act.place | Founder/CEO |
| Sally Grimsley-Ballard | Snow Foundation | s.grimsley-ballard@snowfoundation.org.au | Strategic Partner |
| Sam Davies | Defy Design | sam@defydesign.org | Manufacturing |
| Judith Meiklejohn | Orange Sky | judith@orangesky.org.au | Social Enterprise |
| Corey Tutt | DeadlyScience | ceo@deadlyscience.org.au | CEO, Advisor |
| April Long | SMART Recovery Aus | along@srau.org.au | Advisory |
...
| Source | Amount | Program | When |
|--------|--------|---------|------|
| Snow Foundation | $193,785 | Multiple grants ($25K + $25K + $100K + misc) | 2024–2026 |
| The Funding Network | $130,000 | Pitch event | Sept 2025 |
| FRRR | $50,000 | Backing the Future | 2025 |
| Vincent Fairfax Family Foundation | $50,000 | Grant | 2025 |
| AMP Spark | $21,900 | Program funding | 2025 |
| **TOTAL** | **$445,685** | | |

**Production facility:** ~$100K invested (TFN $80K + ACT $20K)

### Key Funder: Snow Foundation
- **Sally Grimsley-Ballard** (Head of Partnerships), **Georgina Byron AM** (CEO)
- Also: a.machuca@snowfoundation.org.au, m.meredith@snowfoundation.org.au
- Relationship began October 2024. Deep trust. Sally travelled to Tennant Creek.
- Supports RHD prevention strategy alignment. Discussed dynamic consent principles.
- Co-creating partnership agreement templates.
- **Q1 2026 proposal:** $120K ($60K for 100 stretch beds + $60K production facility)

### Pending / In Discussion

| Funder | Amount | Type | Status | Contact |
|--------|--------|------|--------|---------|
| Snow Foundation (Round 4) | $200,000 | Grant | Proposal pending | Sally Grimsley-Ballard |
...
| Can wash regularly (power/detergent) | Only 38% | FRRR, 2022 |
...
| Very remote homes with structural problems | 54.6% | AIHW |
| Mattress cost in remote | $1,200+ (2x city) | AFSE research |
...
| Healthcare savings per $1 washing investment | $6 saved | Treatment cost analysis |
| Washing machine lifespan in remote | 1–2 years (vs 10–15) | East Arnhem Spin Project |

### Why Washing Machines Fail (East Arnhem Spin Project, ~500 homes audited)
- Blocked pumps (dirt/lint), broken suspension rods (40%+ of Simpson machines)
- 2,300 cycles/year vs 200 typical; vermin damage; incorrect installation; no local repair
...
**Important:** The "40% community share" referenced in some older documents is a **placeholder concept**, not a committed structure.

The actual model is being **co-designed with communities** and may include:
...
**Ultimate success:** "When someone asks 'Who makes these?' and the answer is 'We do.'"
...
|------|-----------|--------|------------|
| Insufficient plastic waste quality/quantity | Medium | Medium | Multiple collection points; Envirobank partnership; quality sorting |
| Production facility demand insufficient | Medium | High | Orange Sky model; multiple interested hosts (PICC, Tennant Creek Shed) |
| Skills gap for manufacturing | Medium | Medium | Defy Design training; tiered roles; Ebony + Jahvan pipeline |
| Zero-margin product delivery | High | High | Building inventory for commercial sales; SEFA loan; corporate engagement |
| Philanthropy dependence | Medium | High | PFI + SEFA = non-grant; diversified funding; asset-based model |
| Scaling before adequate testing | Medium | High | V4 informed by 140+ deployments; 200–300 beds minimum before major scale |
| Transport costs to remote | High | Medium | Local production model; containerised circuit deployment |
| V.1 bed hesitancy | Known | Medium | V.2 Stretch Bed well-received; all future = V.2 |
...
| Production Walkthrough | Raw footage | https://share.descript.com/embed/QRzMJxd1Jo3 |

### Local Video Files (v2/public/video/)
- jaquilane-testimony.mp4, building-together-desktop.mp4, community-desktop.mp4, recycling-plant-desktop.mp4, stretch-bed-desktop.mp4

### Photo Assets (v2/public/images/)
- **Product:** stretch-bed-hero, washing-machine, washing-machine-hero, washing-machine-name, kids-building
...
### Asset Register (Production)
- **Database:** Supabase (PostgreSQL), project `cwsyhpiuepvdjtxaozwf`
- **389 assets tracked** across 8 communities in real-time
- **5 tables:** assets, checkins, tickets, usage_logs, alerts
- **QR codes:** 389 unique codes (SVG + PNG), organised by community/product
- **Cost:** $12–20/year infrastructure

### Web Platform (v2)
- **URL:** goodsoncountry.au
- **Stack:** Next.js 16 + React 19 + TypeScript + Tailwind + Supabase + Stripe
...
4. Capability (how ready is the system to act?)
5. Option Value (does this open future possibilities?)
6. Community Value Return (does value flow back to community?)
...
| **March 9, 2026** | **Major update: Added all funding pipeline, advisory board with emails, 13+ partners with contacts, production facility specs, Envirobank supply chain, outstanding receivables, video/media catalogue, REAL Innovation Fund + PFI applications, V.1 vs V.2 bed feedback, risks & mitigations, ALMA framework, environmental metrics. Data sourced from full sweep of Supabase, Notion, GHL, Gmail, calendars, and Goods codebase.** |

---

*This document is the single source of truth for Goods on Country content. All page content, pitch materials, grant applications, and external communications should reference this compendium.*
