...
### Tennant Creek, NT
**Wumpurrarni Country** | Heart of the Barkly Region

One of the most under-resourced towns in Australia for essential goods. GOODS deployed five washing machines in partnership with Wilya Janta and Anyinginyi Health. The collaboration with Traditional Owner Dianne Stokes exemplifies the co-design approach.

---

### Kalgoorlie, WA
**Goldfields Region** | 600km east of Perth

Fourteen tribal groups converge around this region. Many people live on the fringes of town at camps like Boulder Camp. Support workers from Bega have documented urgent need for bedding solutions that address both health and dignity.

---

### Mt Isa, QLD
**Kalkadoon Country** | Far Northwest Queensland

Ongoing collaborations with community leaders have resulted in co-designed bedding solutions. Testing has confirmed durability and ease of assembly.

---

### Darwin, NT
**Partnership with Red Dust**

Wayne Glenn and the Red Dust team have provided critical context on systemic health challenges and the role of bedding in addressing root causes like rheumatic heart disease.
...
Requests received from health workers documenting the direct connection between lack of washing machines, scabies outbreaks, and rheumatic heart disease.
...
After receiving a GOODS bed:

> "It's more better than laying around on the floors… It was easy to make. Yeah, it's nice."

**Impact**: First-hand validation that simple, functional design improves daily life.
...
Alfred articulates both the logistical barriers and the emotional significance of having a bed.
...
Alfred also describes overcoming shame as key to community engagement:
...
**Impact**: Connects physical comfort to safety, dignity, and community pride.
...
These two women highlight the gap between family obligation and available resources.

> "Sometimes family don't have extra mattresses. Kids sleep out with family or have to have their friends over."

They emphasize the importance of bedding during gatherings:
...
**Impact**: Validates the need for versatile, portable solutions for cultural gatherings.
...
Daniel provides cultural and economic context.

> "The importance of visiting family, feeling at home, and engaging with extended family members on Palm Island highlights the strong sense of community and belonging."

On economic barriers:

> "Residents face high costs of shipping goods, leading to difficulties in furnishing homes and the tendency to opt for cheaper options that may not last long."

On cultural sensitivity:

> "The significance of understanding and respecting local cultural protocols and community contexts, the importance of seeking permission and observing sensitivities in indigenous communities."

He suggests practical solutions:

> "Versatile furniture that can act as a bed and a coffee table, catering to the needs of accommodating family members and visitors."

**Impact**: Frames the work within cultural obligation and protocol.

---

#### Jason
*Long-term Palm Island Resident*

Jason speaks from extended experience with GOODS products.

> "The beds are suitable for outdoor spaces and versatile in their use."

> "Engaging with the community and supporting families requires clear communication and establishing a collaborative approach."

> "The value of traditional practices and their impact in enhancing daily experiences and promoting mobility."
...
#### Dianne Stokes
*Elder & Traditional Owner*

Dianne is a pivotal figure in the GOODS story. She received one of the first washing machines deployed in Tennant Creek.
...
Jimmy worked with GOODS on the Weave Bed prototype.
...
> "Washable, repairable, community-built."

**Impact**: Community-led innovation. The weave bed represents co-creation, not just delivery.
...
#### Gloria
*Community Elder, Dialysis Patient, Great-Grandmother*

Gloria connects mattress quality directly to health outcomes.
...
> "Emphasis on the need for a comfortable mattress for a good night's rest, the impact of a mattress on overall health."
...
**Impact**: Links bedding to health management for chronic conditions.

---

#### Walter Young
*Boulder Camp Resident, originally from Woburton*

Walter has deep attachment to Boulder Camp and speaks to sleep quality.
...
**Impact**: Connects place, belonging, and physical comfort.

---

#### Chloe
*Aboriginal Homeless Fringe Support Worker, Bega*
...
**Impact**: Front-line validation of health-bedding connection.

---

#### Dena
*Social Support Manager, Bega*

Dena sees the systemic picture and the opportunity for community ownership.
...
**Impact**: Frames GOODS as potential community enterprise, not just aid.
...
Mark tested the bed design and validated durability.
...
**Impact**: User testing validation.
...
Wayne provides systemic health context.

> "The dialogue centers around health issues in Indigenous communities, discussing systemic challenges, health programs, and the importance of addressing root causes to tackle entrenched health issues."

> "The conversation addresses the challenges of poor bedding environments in remote communities, emphasizing the need for practical, transportable, and hygienic bedding solutions as an essential element for improving living conditions."
...
**Impact**: Connects GOODS to broader health systems change.

---

### Gapuwiyak & East Arnhem

#### Jessica Allardyce
*Miwatj Health*

Jessica articulates the direct health pathway.
...
> "Space/buildings are limited, so unsure of a suitable location to manufacture goods. Community members would also need upskilling."

**Impact**: Clinical validation of the scabies → RHD pathway. Justifies washing machine priority.
...
#### Simone Grimmond
*WHSAC (submitted via Goods Request Form)*
...
### 1. The Freight Tax
Every remote community pays a "remoteness premium" that makes essential goods unaffordable:
...
Multiple storytellers and health workers link bedding directly to health outcomes:
...
| Community | Storytellers | Key Goods | Status |
|-----------|--------------|-----------|--------|
| Palm Island | 6 | Beds, mattresses | Deployed, positive feedback |
| Tennant Creek | 2 | Washing machines, weave beds | 5 machines deployed, prototype testing |
| Kalgoorlie | 4 | Raised beds, mattresses | Demo and distribution ongoing |
| Mt Isa | 2 | Beds | Testing and co-design |
| Darwin | 1 | Prototype bedding | Red Dust partnership |
| Gapuwiyak | 1 | Washing machines, beds | Request received |
| Groote | 1 | Mattresses (500), machines (300) | Request quantified |

---

## What Makes GOODS Different

1. **Extended presence**: Multi-week residencies, not drive-by consultations
2. **Co-design**: Products shaped by community input (weave bed, button language)
3. **Cultural protocol**: Permission-seeking, sensitivity to local contexts
4. **Practical innovation**: Washable, portable, repairable, off-the-ground
5. **Systemic connection**: Working with health services (Miwatj, NT Health, Red Dust)
6. **Community ownership pathway**: Building toward local enterprise and skill development
...
- Empathy Ledger storyteller interviews and transcripts
- GOODS Request Form submissions (Notion)
...
*Document generated from Empathy Ledger platform data, January 2026*
