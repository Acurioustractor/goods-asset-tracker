 ...
 *      their basis, so a reviewer does not compare unlike scopes.
 *
 * It NEVER writes a money figure. Drift and external-send finance checks go to
 * wiki/canon/needs-signoff.md. Hard inconsistency
...
const signoff = [
  `# Canon money external-send checks (as of ${stamp})`,
  '',
