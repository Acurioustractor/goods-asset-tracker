-- SAFE UPDATE - Keeps all existing slugs for QR codes
-- Only updates content and adds metadata

-- basket-bed-single - keep slug, update content
UPDATE products SET
...
The Greate Bed is built to last in tough conditions: a 200kg load capacity, no tools required for assembly, and a 5-year warranty.',
  ...
  metadata = '{
    ...
    "enterprise_opportunity": {"enabled": true, "title": "Run this enterprise in your community", "description": "Communities can license the Goods model to manufacture and distribute beds locally, creating employment and keeping 100% of profits in community.", "benefits": ["Full training and ongoing support", "Supply chain and material connections", "Marketing materials and brand usage", "Quality assurance framework"], "contact_cta": "Express Interest"}
  }'::jsonb
WHERE slug = 'basket-bed-single';

-- basket-bed-double - keep slug, update content
UPDATE products SET
...
Like all Goods products, the double Greate Bed is built on a foundation of community ownership. 40% of every sale returns directly to the artisans and their communities.',
  ...
  images = ARRAY['https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686f06aca919ac39a08c6cbc_20250629-IMG_7731.jpg', 'https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686e5122692fd1a0ee508f2e_20250628-IMG_6872.jpg'],
  is_active = true,
  is_featured = true,
  metadata = '{
...
WHERE slug = 'basket-bed-double';

-- weave-bed-single - keep slug, update content (Stretch Bed)
UPDATE products SET
...
At just 12kg, the Stretch Bed can be carried by one person, yet still supports 200kg and carries the same 5-year warranty as our Greate Bed.',
  ...
  images = ARRAY['https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686f0a19b97e3e9c7b4dc6f0_20250628-IMG_6976.jpg', 'https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686e5122692fd1a0ee508f2e_20250628-IMG_6872.jpg'],
  is_active = true,
  is_featured = true,
  metadata = '{
...
WHERE slug = 'weave-bed-single';

-- weave-bed-double - keep slug, update content
UPDATE products SET
  ...
  product_type = 'stretch_bed',
  featured_image = 'https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686e5122692fd1a0ee508f2e_20250628-IMG_6872.jpg',
  images = ARRAY['https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686e5122692fd1a0ee508f2e_20250628-IMG_6872.jpg'],
  is_active = true,
  is_featured = false,
  metadata = '{
...
WHERE slug = 'weave-bed-double';

-- washing-machine-standard - keep slug, update content
UPDATE products SET
...
Specs: 8kg capacity, 50L water per cycle, 1200W solar-compatible, 2-year warranty.',
  ...
  featured_image = 'https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686f06aca919ac39a08c6cbc_20250629-IMG_7731.jpg',
  images = ARRAY['https://cdn.prod.website-files.com/64ea91d86ff3fda1ff23fb95/686f06aca919ac39a08c6cbc_20250629-IMG_7731.jpg'],
  is_active = true,
  is_featured = true,
  metadata = '{
...
WHERE slug = 'washing-machine-standard';

-- Verify updates (shows all products with their status)
SELECT slug, name,
  CASE WHEN metadata IS NOT NULL AND metadata::text != '{}' AND metadata::text != 'null'
       THEN '✓ HAS METADATA'
       ELSE '✗ NO METADATA'
  END as status
FROM products
