    ...
    entries: [
      {
        ...
        tags: ['role:media', 'interest:media-pack', 'act-inquiry', 'project-goods'],
        state: 'built-off',
        note:
    ...
    steps: [
      {
        ...
        theyGet: 'Nothing automated today.',
        messageClass: 'answer',
        advance: 'A reply with the link to /press and an offer of a person to talk to.',
        state: 'built-off',
        gap: 'The workflow exists and sends nothing. Fix it or rename it, but do not leave it looking like it works.',
      },
      {
        id: 'media-pitched',
