...
export const ARTEFACTS: readonly Artefact[] = [
  ...
  { id: '14', title: 'Sefa lender page: the bed, the year, the repayment case, the entity', state: 'held', kind: 'built', owner: 'Ben', askedFor: "SEFA, Joel Bird's visit 18 September; the lender case behind QBE Q14 and Q18", funders: ['sefa'], notionId: '3deebcf981cf81119dabd97408494ff7', files: ['14-sefa-lender-page.pdf', '14-sefa-loan-test.xlsx'], where: 'Sefa is out of this raise (Ben, 19 Sep 2026); kept for the record.' },
  ...
  { id: 'asic-acnc', title: 'ASIC and ACNC extracts for all three entities', state: 'held', kind: 'board-and-legal', owner: 'Ben', askedFor: 'QBE Q1, Q4 and Q22', funders: ['qbe'], notionId: '3dcebcf981cf81c4b73ee570b79c66f0', where: 'ASIC company summaries for all three entities and the ACNC register page, extracted 19 Sep 2026, on the Notion row. Free summaries do not list officeholders.' },
  { id: 'charity-dgr', title: 'Charity registration and deductible gift endorsement', state: 'held', kind: 'board-and-legal', owner: 'Ben', askedFor: 'QBE Q22; Mazda needs the DGR and ITEC dates', funders: ['qbe', 'mazda'], notionId: '3dcebcf981cf81d28d86c247423bd88d', where: 'ABN Lookup record (DGR Item 1 from 17 Jan 2012) and the ACNC registration page, 19 Sep 2026, on the Notion row.' },
  ...
  { id: 'annual-report', title: 'Most recent annual report', state: 'held', kind: 'board-and-legal', owner: 'Ben', askedFor: 'Tim Fairfax 7.1; a Brian M. Davis link', funders: ['tfff', 'bmd'], notionId: '3dcebcf981cf813faad4f8b7b9ad77b7', where: 'goodsoncountry.com/annual-report (FY26, live 18 Sep 2026); attachment 15, the year so far. Audited statements added after the AGM.' },
  ...
  { id: 'contact-schedule', title: 'Private contact schedule for the funders named at Q14', state: 'held', kind: 'funder-correspondence', owner: 'Ben', askedFor: 'QBE Q16', funders: ['qbe'], notionId: '3dcebcf981cf81528d56d9fe2742aaf5', where: 'On the Notion row, private. Drop the Sefa contact now Sefa is out.' },
  { id: 'support-letters', title: 'Support letters: two for Brian M. Davis, one from a community partner for Tim Fairfax', state: 'partial', kind: 'funder-correspondence', owner: 'Ben', askedFor: 'Brian M. Davis; Tim Fairfax 5.2', funders: ['bmd', 'tfff'], notionId: '3dcebcf981cf81049b04c95b7184464c', finishes: 'Homeland School Company letter held (PDF on the BMD row). Oonchiumpa letter held as Word: save as signed PDF. Tim Fairfax 5.2 letter asked for by 2 October.' },
  ...
  { id: 'budget-template', title: 'Budget template, year-one column', state: 'held', kind: 'funder-correspondence', owner: 'Ben', askedFor: 'Brian M. Davis', funders: ['bmd'], notionId: '3dcebcf981cf81b4ac9cfcfefc9f5f78', where: 'Google Sheet 1e-1LUcOZA4ivkWrSORlHOWmRIttIyd0Uqf3a5nD28KY, complete: $99,750, one line, note 1. Download as xlsx to upload.' },
