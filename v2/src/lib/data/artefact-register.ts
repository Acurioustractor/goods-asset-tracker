...
export const ARTEFACTS: readonly Artefact[] = [
  ...
  { id: 'support-letters', title: 'Support letters: two for Brian M. Davis, one from a community partner for Tim Fairfax', state: 'missing', kind: 'funder-correspondence', owner: 'Ben', askedFor: 'Brian M. Davis; Tim Fairfax 5.2', funders: ['bmd', 'tfff'], notionId: '3dcebcf981cf81049b04c95b7184464c', finishes: 'Drafted 17 September; sent to the signatories when Ben says.' },
