...
export const ROUTE_AUDIENCES: RouteAudience[] = [
  ...
  {
    route: '/admin/model/structure',
    audience: 'internal',
    access: 'admin',
    leadsWithNow: null,
    whyUnread: 'admin surface: the structure and funding-flow diagram rendered from typed data, behind the admin gate',
    verdict: 'keep',
  },
  {
    route: '/admin/model/svg',
    audience: 'internal',
    access: 'admin',
    leadsWithNow: null,
    whyUnread: 'redirect only: the SVG sheet became the placemat at /admin/model',
    verdict: 'keep',
  },
  {
    route: '/admin/model/ten-years',
    audience: 'internal',
    access: 'admin',
    leadsWithNow: null,
    whyUnread: 'admin surface: the ten-year scale table behind the pitch slider, behind the admin gate',
    verdict: 'keep',
  },
  {
  ...
  },
  {
    ...
    access: 'open',
    leadsWithNow: null,
    whyUnread: 'scrolly narrative, absorbed into /pitch, kept until Ben says which ships',
    verdict: 'keep',
  },
  {
