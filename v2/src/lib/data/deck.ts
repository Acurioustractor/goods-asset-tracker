...
export const deckSlides: DeckSlide[] = [
  // ────────────────────────────────────────────────────────── cover
  {
    ...
    place: `${CANONICAL_ASSETS.bedsDeployed} beds · ${CANONICAL_ASSETS.communitiesServed} communities · three years`,
    goDeeper: [
  ...
  // ────────────────────────────────────────────────────────── the gap
  {
    ...
    kind: 'gap',
    eyebrow: 'The gap',
    headline: 'Three years, eleven communities, 540 beds. Nobody owns the making.',
