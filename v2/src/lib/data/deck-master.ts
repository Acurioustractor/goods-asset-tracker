...
export const DECK: readonly DeckSlide[] = [
  ...
  { id: 'S04', name: 'How Goods works', job: 'Explain the method', say: 'Listen, make something useful, test it on Country, improve it and keep supporting it.', visual: 'The Goods method and the Goods on Country production facility in Queensland.', currentTitle: 'How useful products become a local service system.', note: 'Explain the operating method once. If the drawing is too dense, reduce it to the five verbs and one line about the Queensland facility.', home: '#people' },
  ...
  { id: 'S08', name: 'Where the work has travelled', job: 'Show reach and evidence', say: 'The work has travelled across Country, while production currently sits at the Goods on Country facility in Queensland.', visual: 'Current Country-led map and reconciled evidence band.', currentTitle: 'The work has travelled a long way.', note: 'Every number and place must remain tied to the reconciled evidence.', home: '#map' },
  ...
  { id: 'S10', name: 'Maningrida', job: 'Show assembly on Country', say: 'Flat-packed parts can travel and become useful beds through local hands.', visual: 'Existing Maningrida photographs, quote, film callout and QR.', currentTitle: '40 Stretch Beds. Made in Queensland. Assembled at Gamardi.', voices: 'Tehmineh Mason’s approved quote can support the spoken presentation.', home: '#maningrida' },
