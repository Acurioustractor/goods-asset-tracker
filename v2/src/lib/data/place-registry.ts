...
export const PLACES: readonly Place[] = [
  ...
  { id: 'ampilatwatja', name: 'Ampilatwatja', kind: 'community', state: 'NT', inRegister: true },
  { id: 'angurugu', name: 'Angurugu', kind: 'community', state: 'NT', within: 'groote-archipelago', inRegister: true },
  ...
  { id: 'umbakumba', name: 'Umbakumba', kind: 'community', state: 'NT', within: 'groote-archipelago', inRegister: true },
