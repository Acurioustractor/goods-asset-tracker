...
export const TRANSCRIPT_PROVENANCE: Record<string, TranscriptProvenance> = {
  ...
  'Kylie Bloomfield': {
    ...
    approxWords: 3646,
    releaseState: 'blocked_no_review_or_grant',
    note: 'Analysis authorised by Ben 2026-07-20 (blanket, all storytellers); analysed in the Voice Impact Model. Release not yet granted.',
  },
  'Margaret Lloyd': {
    kind: 'el-transcript',
    transcriptCount: 1,
    approxWords: 292,
    releaseState: 'blocked_no_review_or_grant',
    note: 'THE Utopia Margaret (Ben confirmed 2026-07-20). EL transcript 0ecb0185 (filed with no project, included via EXTRA_TRANSCRIPT_IDS): recorded at her bed delivery, "Wenitong" homeland (spelling as transcribed), ~30 years there, sleeping in a tent with no mattress before. Deck-grade delivery testimony pending quote clearance.',
  },
  'Fred Campbell': {
    kind: 'el-transcript',
    transcriptCount: 1,
