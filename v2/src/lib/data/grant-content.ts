...
export const grantAnswers = {
  ...
  howDoYouMeasureImpact: 'We track impact through: (1) Asset Register — 603 asset rows with QR-coded lifecycle monitoring. (2) Telemetry — 18 washing machines in community, with fleet telemetry not yet fleet-wide. (3) Community feedback — 500+ minutes recorded, 15+ verified storytellers via Empathy Ledger. (4) Environmental metrics — 3,460kg+ plastic diverted (173 Stretch beds x 20kg HDPE, Stretch only; Basket Beds are not a plastic product). (5) Health outcomes — tracking with health partners.',
