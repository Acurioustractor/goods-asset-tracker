...
export const communityPartnerships = [
  {
    ...
    headline: 'A relationship built through return',
    description: 'Goods has kept returning to Tennant Creek. Elder Dianne Stokes received a bed and came back within two weeks requesting twenty more. Norman Frank called asking for three beds in maroon after his daughter tried one. Dianne later gave the washing-machine prototype its Warumungu name: Pakkimjalki Kari.',
...
export const communityLocations: CommunityLocation[] = [
  {
    ...
    storytellerCount: 6,
    bedsDelivered: 160,
    description: 'One of Goods’ deepest community relationships. Elder Dianne Stokes received a bed and came back requesting twenty more.',
    highlight: 'Dianne named the washing machine "Pakkimjalki Kari" in Warumungu language',
  },
  {
    id: 'palm-island',
...
export const mediaPack = {
  // About A Curious Tractor. Ruling X, 28 Aug 2026, and ruling AA, 5 Sep 2026: Goods on Country is
  // the single operating and public identity, and it is a registered business name of The Butterfly
  // Movement Ltd. ACT is a related organisation, never the parent of Goods on Country.
  aboutACT: `A Curious Tractor is a related organisation, founded in September 2023 by Nicholas Marchesi and Benjamin Knight to design, manufacture, and transfer ownership of essential goods to remote First Nations communities across Australia. The name reflects the approach: curiosity-driven problem solving applied to entrenched disadvantage. Goods on Country is a registered business name of The Butterfly Movement Ltd.`, // NOTE: ACT (A Curious Tractor Pty Ltd) is NOT a registered charity or DGR entity — do not add that claim here.

  // Copy-paste-ready press boilerplate
  pressBoilerplate: `Goods on Country is a social enterprise delivering durable, community-designed essential goods to remote First Nations communities across Australia. The flagship product, the Stretch Bed, is a flat-packable, washable bed made from recycled HDPE plastic, galvanised steel, and heavy-duty Australian canvas. Each bed diverts 20kg of plastic from landfill, assembles in under five minutes with no tools, and supports up to 200kg. With 540 beds delivered across 11 communities, Goods on Country addresses the environmental health conditions that drive preventable disease, including Rheumatic Heart Disease, by putting health hardware directly into the hands of families who need it. The organisation's long-term goal is to transfer manufacturing capability to community-owned enterprises. Goods on Country is a registered business name of The Butterfly Movement Ltd, an ACNC-registered charity.`,
