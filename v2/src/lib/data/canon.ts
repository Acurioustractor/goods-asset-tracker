...
export const CANON: CanonFact[] = [
  ...
  {
    id: 'entity-dgr-home', label: 'Charity / DGR home', value: 'Goods on Country Ltd (formerly The Butterfly Movement Ltd), ABN 22 155 132 684',
    domain: 'governance', claimLabel: 'verified', dataClass: 'green',
