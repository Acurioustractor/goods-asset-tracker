...
export const DECK_ROAD: Slide[] = [
  ...
  ...stopSlides,
  {
    ...
    body: 'Seven places, three years, and a product that works. What has not happened anywhere is the transfer. And the need is not abstract: the Census counts 2,761 very remote NT households short at least a bedroom, half of all of them. Three years of this work has delivered 540 beds. This is the honest position, and it is the reason for the ask.',
    figures: [
