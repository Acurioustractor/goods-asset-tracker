/**
 * QUESTIONS PEOPLE ASK: the living FAQ behind the QBE story.
 *
 * Every room asks a version of the same twenty questions, and "where are they selling?" is asked
 * in all of them. This file is where an answer lives once, in the founders' words, with who asked
 * it, when, and where the answer comes from. Add a question the day it is asked; mark it `open`
 * until there is an answer Ben would say out loud; the page renders open ones as open.
 *
 ...
 *  - $750,000 is only ever the cost of the beds;
...
export interface FaqEntry {
  id: string;
  question: string;
  /** In the founders' words. Empty only while `status` is `open`. */
  answer: string;
  status: FaqStatus;
  /** Who asks it, by role, never by name. */
  askedBy: string;
...
export const FAQ: readonly FaqEntry[] = [
  {
    ...
    answer: `Mparntwe first, with Oonchiumpa, who have already built and delivered beds with their young people. Buyers are already paying. ALIVE National Centre bought 100 beds up front. Centrecorp has 130 on quote. There are more than 200 requests each in Tennant Creek and Mparntwe. Each community sells its own pool under its own rules, to families, local organisations, the health service or a buyer like Centrecorp. Who is buying the sold beds is the first of the four gates, and it is named per place before any bed moves.`,
    status: 'partly',
    askedBy: 'Every room: Social Impact Hub, foundation program leads, the advisory committee',
    asked: '2026-09-02',
    chapter: 'buyers',
  ...
  },
  {
    ...
    status: 'answered',
    askedBy: 'A foundation program lead, and the deck itself until 2 September',
    asked: '2026-09-02',
    chapter: 'money',
  ...
  },
  {
    ...
    status: 'answered',
    askedBy: 'Social Impact Hub, form Q5 to Q7',
    asked: '2026-09-03',
    chapter: 'bed',
  ...
  },
  {
    ...
    status: 'answered',
    askedBy: 'Dusseldorp Forum, 2 September call',
    asked: '2026-09-02',
    chapter: 'loop',
  ...
  },
  {
    ...
    answer: `Ownership is a pathway, and we say so on every page. Goods on Country holds the products, the IP, the contracts and the equipment today, with an Indigenous-led board. Each community holds its pool and its decisions. Six months into a site we ask four questions: who holds the keys, who runs the payroll, who invoices the buyer, is at least half the production local. Partial counts as no. Until the answers are yes, nobody claims ownership has moved.`,
    status: 'answered',
    askedBy: 'Investors and the advisory committee',
    asked: '2026-07-26',
    chapter: 'decides',
  ...
  },
  {
    ...
    answer: `No. What we hold is three written invitations to apply for named amounts, each from a person Social Impact Hub can call, and a paid purchase order that proves demand. We say that first, every time.`,
    status: 'answered',
    askedBy: 'Social Impact Hub, form Q14',
    asked: '2026-08-01',
    chapter: 'money',
  ...
  {
    id: 'which-entity',
    question: 'Which entity applies and receives the money?',
    answer: `Our recommendation is The Butterfly Movement Ltd, trading as Goods on Country. Everything Goods sits there since 28 August, and every funder's money already lands there. A Curious Tractor entered the cohort in March and is the historic maker, moving its assets across. If Social Impact Hub says the cohort entrant must apply, A Curious Tractor applies and the answer rests on the agreement between the two, which is not yet signed. That is weaker, and we say so.`,
    status: 'open',
    askedBy: 'Social Impact Hub, form Q1, Q2, Q8; asked of Social Impact Hub on 3 September',
    asked: '2026-09-02',
    chapter: 'entity',
  ...
  },
  {
    ...
    status: 'answered',
    askedBy: 'Social Impact Hub, form Q19',
    asked: '2026-09-03',
    chapter: 'measured',
  ...
  },
  {
    ...
    answer: `Open, and it is the biggest single dial in the model. A site has a floor cost the day anyone works there, and the wage of whoever runs the line is the part no pool covers on its own. It is one of the four gates: an operator and a place, named, with someone paying them. The answer will be different at each site and it is agreed in the rules before the beds move.`,
    status: 'open',
    askedBy: 'Matt Allen, the financial model sessions; Ben and Nic between themselves',
    asked: '2026-07-25',
    chapter: 'measured',
  ...
  },
  {
    ...
    answer: `No. The funder acts once, and after that the money goes round inside the community. The only money that is repaid is the plant finance, and that comes back to the lender out of what Goods on Country makes on buyer orders. Never out of a community's pool. Nobody is buying shares.`,
    status: 'answered',
  ...
  },
  {
    ...
    status: 'answered',
    askedBy: 'Ben and Nic, of themselves',
    asked: '2026-09-03',
    chapter: 'measured',
    source: 'QBE page 1.9',
  },
  {
    ...
    answer: `No. Scabies and rheumatic heart disease are the reason the hardware matters. The beds are washable and off the ground because of them. That is where the claim stops. We count beds, hours, control and plastic, and we do not claim health outcomes.`,
    status: 'answered',
  ...
  },
  {
    ...
    answer: `Its margin on buyer orders, which is what repays any plant finance, and the money that runs the organisation, which is raised separately. ${THE_BLOCK.line} Bed money never funds this. Tim Fairfax invited The Butterfly Movement to apply for three years of that support, and Katie Norman said the reason is the resilience of organisations doing good work.`,
    status: 'answered',
    askedBy: 'Tim Fairfax Family Foundation, 31 August',
    asked: '2026-08-31',
    chapter: 'money',
