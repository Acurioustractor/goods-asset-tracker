...
export const storyStops: StoryStop[] = [
  ...
  // ────────────────────────────────────────────────────────── money
  {
    ...
    headline: 'Seven funders. Snow went first, in October 2023.',
    chapters: [
      ...
      'The funding mix tells the truth about the stage of the venture. Grants and philanthropy have brought in $772,788 across seven funders, tied to the books on 16 September 2026. Paid bed trade has brought in $247,770 net of GST. On those two reconciled figures, about three quarters of the money in has been philanthropic. Direct online shop revenue in the historical record is only $90, from three orders. Institutional purchases and partner-funded deployments sit between those two categories, and that is the channel that now needs to become repeatable.',
      ...
      'The order matters more than the amounts. Snow Foundation was backing this work from October 2023, before there was a product, a register, a charity, a board or a customer, and committed to Goods itself in October 2024 with the words "initial seed funding for your entrepreneurial remote mattress project". They have paid ten invoices, the most recent in May 2026. AMP Tomorrow Makers Spark followed in 2024, then QIC, then Vincent Fairfax with FRRR, whose Backing the Future grant funded the Palm Island deployment and was acquitted in March 2026. The Funding Network\'s Healthy People, Healthy Planet event banked $144,558 toward the On-Country production facility across two receipts in November and December 2025. The John Villiers Trust and the QBE Foundation are the most recent. Georgina Byron, who runs the Snow Foundation, puts the job this way: "We can do our bit. And we can catalyse others to do their bit as well."',
    ...
    figures: [
      ...
      { value: '$772,788', label: 'grants and philanthropy received, seven funders', claim: 'verified' },
    ],
    note: '2026-09-16: the "about 89 per cent from grants and philanthropy" claim was REMOVED. Its denominator was never written down and it does not tie: grants received ($772,788) exceed the $713,827 revenue figure in the paragraph above, so they cannot be 89 per cent of it. Replaced with the two figures that are each tied to a source (grants-received.ts and paid-trade.ts), which put the philanthropic share at about three quarters. Do not restore a percentage without naming its denominator. Same pass: Centrecorp came out of the philanthropy paragraph (they are a BUYER, 107 beds on INV-0291, Ben\'s ruling), and The Funding Network went from "about $130,000" to the $144,558 actually banked. RULING H APPLIED. The Notion source calls $713,827 "accountant-signed". It is NOT. No signed accountant document exists; the word came off 8 surfaces and must not return through this page. The figure is correct, the label is workpaper. RULING O: $110,046 IS the actual sunk spend; the ~$75K MVF figure is a bill-level subtotal, not a competing total. The live capital ask (the $400K match, QBE, the stack) is deliberately NOT on this page: it is dated, it moves weekly, and it belongs on the pitch surfaces, not in the history.',
  },
