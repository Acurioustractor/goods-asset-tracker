...
export const storyStops: StoryStop[] = [
  // ────────────────────────────────────────────────────────── stop 1
  {
    ...
    chapters: [
      ...
      'They drove around looking for it. Perhaps the wind had taken it. Perhaps it had broken. Perhaps the family had decided the thing was useless. Then they looked inside the tent. Gloria and her relatives had pulled the Basket Bed in, and four women were sleeping on it. Gloria Turner is the first person who used a Goods bed.',
    ...
    note: 'The disappearing-bed scene is narration, not a quote: no attributable speaker exists for it. Gloria Turner carries the stop with her registry PRIMARY quote. BEN RULED THE COUNT 2026-09-04: four women were sleeping on the bed, Gloria Turner among them. That supersedes the earlier \'keep both records visible\' instruction and the paragraph that held it (the contemporaneous field recording said six people in the tent with three on the first mattress; a later team retelling said six women on it together). Both are in git history. Do not reinstate them. Gallery is place-attributed with no people in it, which is why it can carry the supply failure without a consent question.',
  },
