...
export const PITCH_MENU_TILES: Record<string, MenuTile> = {
  ...
  buyers: { src: '/images/community/palm-island/woman-boy-new-bed.jpg', span: 'one', position: 'center 35%' },
  model: { src: '/images/model/whole-model-tile.jpg', drawing: true, span: 'big' },
  measure: { src: '/images/community/palm-island/two-men-thumbs-up.jpg', span: 'one', position: 'center 35%' },
