...
export const LINES: readonly Line[] = [
  ...
  },
  {
    ...
    surface: 'form',
    use: null,
    why: `The ask is $${aud(ASKED_AUD)} across four grants and one loan, and the year needs $${aud(NEED_AUD)}. A $500,000 floor understates by up to $${aud(NEED_AUD - 500_000)} and would be read as the number we need.`,
  },
  {
