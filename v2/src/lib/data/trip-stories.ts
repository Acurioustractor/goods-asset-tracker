  ...
  blocks: [
    ...
    // local production, local employment, better health outcomes.
    {
      ...
      paragraphs: [
        ...
        "A bed off the ground cuts scabies and rheumatic heart disease, and means kids who slept enough to make it to school. Local production on top of that is income that stays in the community. The work, eventually, is to move the making into community ownership.",
      ],
      links: [
