...
export const REGISTER: readonly RegisteredSurface[] = [
  ...
  { title: 'The Model', kind: 'artifact', date: '2026-09-12', url: 'https://claude.ai/code/artifact/051b93d2-24be-4a6b-b6ff-0390889ddff7', job: 'Three drawings and one sentence: where the money stops, how the making moves, the capital model.', verdict: 'absorbed', note: 'Two of its drawings are on the Model screen here with the place name taken out. Its production figures (three beds a day, 576 a year, 36 kg) were withdrawn on 12 September.' },
  ...
  // Retired
  { title: 'Goods on Country Model', kind: 'artifact', date: '2026-09-09', url: 'https://claude.ai/code/artifact/0b235115-7bbb-436f-bbe8-f716c283dcf5', job: 'A scrolling explainer with a scenario engine.', verdict: 'retired', note: 'Carries a share-to-Goods lever that should not exist, a first-stock box that named the place, and five-layers language.' },
