...
export const DOORS: Door[] = [
  {
    ...
    returns:
      'No money comes back. The Butterfly Movement Ltd, trading as Goods on Country, has been endorsed to receive tax deductible gifts since January 2012. We are still working out how the receipt actually gets issued, so ask us where that is up to before you write the amount.',
...
export const DOORS_NOTE =
  'Gifts and loans go to The Butterfly Movement Ltd, trading as Goods on Country (ABN 22 155 132 684). Orders are invoiced by A Curious Tractor Pty Ltd for now.';
