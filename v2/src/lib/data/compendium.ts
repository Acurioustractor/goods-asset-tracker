...
//   Tennant Creek 159, Utopia 147, Palm Island 131, Maningrida 78 (incl. +60 Jul
//   2026), Kalgoorlie 20, Alice Springs 16, Mt Isa 2, Darwin 1, Canberra 2 = 556
//   deployed beds.
...
export const deployments: CommunityDeployment[] = [
  ...
  { id: 'maningrida', community: 'Maningrida', state: 'NT', beds: 78, washers: 2, status: 'active', partner: 'Homeland Schools Co.' },
 ...
 */
export const EXPECTED_DEPLOYED_BEDS = 556; // canonical: see asset-canonical.ts (bedsDeployed)
...
export const environmentalImpact = {
  ...
  // Plastic = STRETCH beds only (193 × 20kg = 3,860 kg). Basket Beds are NOT a
