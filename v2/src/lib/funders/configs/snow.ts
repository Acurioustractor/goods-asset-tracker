...
export const snowConfig: FunderConfig = {
  ...
  investmentTiers: [
    ...
    },
    {
      ...
      budgetAud: 155000,
      description:
        'FY25 main + FY26 Operational + FY26 Scale-Up $60K (incoming). Plant comprises plastic shredder + pellet/sheet press + computer-controlled router. Full deployment capacity: 30 beds/week. Each bed uses 20kg of plastic waste fitting in a 25 L tub. Multi-product capable — same infrastructure will produce washing machines and fridges (Q3-Q4).',
