  ...
  return (
    <div className="min-h-screen bg-goods-cream">
      ...
      <div className="container mx-auto max-w-5xl px-5 py-12">
        ...
        <p className="rounded-2xl border-2 border-goods-clay bg-[#fdf3ef] px-5 py-4 text-sm leading-6 text-[#6b3625]">
        ...
        <header className="mt-10">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-goods-sub">{pathway.invitation}</p>
        </header>
        ...
        <section className="mt-14">
          ...
          <p className="mt-3 max-w-3xl leading-7 text-goods-sub">
          ...
          <div className="mt-8 overflow-x-auto">
            <table className="w-full min-w-[36rem] border-collapse text-left text-sm">
              <thead>
                <tr className="border-b-2 border-goods-sand text-[#37332e]">
                    ...
                    <tr
                      ...
                      className={
                        picked
                          ...
                          : 'border-b border-goods-grid text-goods-sub'
                      }
                    >
                      ...
                      <td className="py-3 pr-4 text-right font-semibold tabular-nums">
                        {rung.perBedEquivalent === null ? (
                          <span className="font-normal italic text-goods-sub">nobody buys this yet</span>
                        ) : (
        ...
        <section className="mt-16">
          ...
          {model.modules.length === 0 ? (
            <p className="mt-5 max-w-3xl leading-7 text-goods-sub">
            ...
            <>
              <dl className="mt-8 grid gap-5 sm:grid-cols-2">
                <div className="rounded-2xl border border-goods-grid bg-white p-6">
                  <dt className="text-sm font-semibold text-goods-sub">To set it up, once</dt>
                  <dd className="mt-2 font-display text-3xl text-goods-ink">
                    {money(model.setup.capexLow)} &ndash; {money(model.setup.capexHigh)}
                  </dd>
                  <p className="mt-3 text-sm leading-6 text-goods-sub">
                ...
                <div className="rounded-2xl border border-goods-grid bg-white p-6">
                  <dt className="text-sm font-semibold text-goods-sub">To keep it running, each year</dt>
                  <dd className="mt-2 font-display text-3xl text-goods-ink">
              ...
              <div
                className={
                  net !== null && net < 0
                    ? 'mt-6 rounded-2xl border-2 border-[#c2703f] bg-goods-cream p-6'
                    : 'mt-6 rounded-2xl border border-[#b9c5ac] bg-[#f4f7f0] p-6'
                }
              >
                <p className="text-sm font-semibold text-goods-sub">
                ...
                {model.annual.grossEarnings === null ? (
                  ...
                  <>
                    ...
                    {model.sells && model.makingPerBed !== null && (
                      ...
                      <p className="mt-2 text-sm leading-6 text-goods-sub">
                    ...
                    {model.buysInputIn && (
                      ...
                      <p className="mt-3 rounded-xl bg-goods-cream px-4 py-3 text-sm leading-6 text-[#6b3625]">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            {[1, 2, 3].map((sites) => (
              ...
              >
                ...
                <p className="mt-1 text-xs text-goods-sub">shared cost, each site</p>
              </div>
            ))}
          </div>
          <p className="mt-4 text-sm leading-6 text-goods-sub">
        ...
        <section className="mt-16">
          ...
          <p className="mt-6 text-sm leading-6 text-goods-sub">
            Next decision on this pathway: {pathway.nextDecision}
          </p>
        </section>

        <footer className="mt-16 border-t border-goods-grid pt-6 text-xs leading-6 text-goods-sub">
