        ...
        <div className="container mx-auto max-w-7xl px-5 py-16 md:py-24">
          <div className="max-w-4xl">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <a
                href="#communities"
                className="inline-flex min-h-11 items-center gap-2 rounded-full bg-goods-ink px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#433f38]"
              >
            ...
            {PATHWAY_STAGES.map((stage, index) => (
              <li key={stage.id} className="flex flex-1 items-start gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-xs leading-5 text-goods-sub">{stage.note}</p>
                </div>
