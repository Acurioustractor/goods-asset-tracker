...
const beds = [
  ...
  { v: '536', l: 'beds in homes across 9 communities since 2023' },
];
  ...
  return (
    <div className="ccstory" ref={root}>
      ...
      <section className="cc-read">
        ...
        <p className="cc-reveal cc-d2">
          Goods on Country has put 536 beds into homes across 9 communities since 2023. This trip added more, and pointed at where the work goes next.
        </p>
      </section>
      ...
      <section className="cc-stats">
        <div className="cc-wrap">
          ...
          <div className="cc-statgrid">
            <div className="cc-stat cc-reveal"><div className="cc-v">536</div><div className="cc-l">beds in homes since 2023</div></div>
