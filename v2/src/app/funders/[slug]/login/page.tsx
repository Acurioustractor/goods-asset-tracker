...
function LoginForm({ slug }: { slug: string }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch(`/api/funders/${slug}/auth`, {
      method: 'POST',
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: '#5E5E5E' }}>
            Enter the access code to view this confidential brief.
          </p>
        </div>
...
export default function FunderLoginPage({ params }: LoginPageProps) {
