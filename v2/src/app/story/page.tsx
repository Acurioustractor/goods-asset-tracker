...
const TIMELINE = [
  ...
  { year: '2024', title: '540 Beds', description: 'Active pilots deliver beds across Palm Island, Tennant Creek, Mt Isa, Kalgoorlie, and more. Community feedback shapes every iteration.' },
  { year: '2025', title: 'Washing Machines', description: 'Pakkimjalki Kari, named in Warumungu language by Elder Dianne Stokes. Commercial-grade, one-button operation. 11 communities served.' },
];
          ...
          <div className="relative z-10 container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-12">
                {[
                  { value: '540', label: 'bed units deployed' },
