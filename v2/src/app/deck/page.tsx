          ...
          <table className="w-full min-w-[640px] border-collapse text-left text-sm">
            ...
            <tbody className="text-muted-foreground">
              {[
                ...
                ['Revenue figure pending sign-off', 'We won’t publish a number the accountant hasn’t signed', 'Hold AU$741,111 publicly until one Goods-only figure is reconciled'],
