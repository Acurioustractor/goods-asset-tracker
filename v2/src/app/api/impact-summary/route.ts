  ...
  try {
    ...
    const body = {
      ...
      notes: {
        ...
        washers: `${a.washersInCommunity} washing machines in community (Ben ruling 2026-07-21, per community: Maningrida 8, Tennant Creek 9, Palm Island 5, Alice Springs 1, Darwin 0; supersedes the raw register row count, 10 stale deployed rows pending restatus).`,
