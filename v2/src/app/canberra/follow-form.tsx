    ...
    <form onSubmit={submit} className="space-y-3">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <input
          ...
          className="w-full rounded-xl border border-[#2E2E2E]/20 bg-white px-4 py-3 text-base text-[#2E2E2E] placeholder:text-[#2E2E2E]/40 focus:outline-none focus:ring-2 focus:ring-goods-terracotta/40"
        />
        <input
          type="tel"
          inputMode="tel"
      ...
      <button
        ...
        className="w-full rounded-xl bg-[#2E2E2E] px-4 py-4 text-base font-semibold text-[#FDF8F3] hover:bg-goods-terracotta transition disabled:opacity-50"
      >
