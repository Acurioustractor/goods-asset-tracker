...
const allPhotos = [
  ...
  ...(media.process.source
    ? [
        {
          id: 'process-source',
          src: media.process.source,
          alt: 'Collecting recycled plastic',
          category: 'process' as const,
          location: undefined as string | undefined,
          community: undefined as string | undefined,
          caption: 'Source',
          subcaption: 'Collecting recycled HDPE plastic from communities',
        },
      ]
    : []),
  ...(media.process.process
    ? [
        {
          id: 'process-melt',
          src: media.process.process,
          alt: 'Processing plastic',
          category: 'process' as const,
          location: undefined as string | undefined,
          community: undefined as string | undefined,
          caption: 'Process',
          subcaption: 'Melting plastic into durable sheets',
        },
      ]
    : []),
  ...(media.process.cut
    ? [
        {
          id: 'process-cut',
          src: media.process.cut,
          alt: 'Cutting bed components',
          category: 'process' as const,
          location: undefined as string | undefined,
          community: undefined as string | undefined,
          caption: 'Cut',
          subcaption: 'Precision cutting with minimal waste',
        },
      ]
    : []),
  ...(media.process.build
    ? [
        {
          id: 'process-build',
          src: media.process.build,
          alt: 'Building bed frames',
          category: 'process' as const,
          location: undefined as string | undefined,
          community: undefined as string | undefined,
          caption: 'Build',
          subcaption: 'Pressing recycled plastic bed legs',
        },
      ]
    : []),
  ...(media.process.weave
    ? [
        {
          id: 'process-weave',
          src: media.process.weave,
          alt: 'Weaving canvas',
          category: 'process' as const,
          location: undefined as string | undefined,
          community: undefined as string | undefined,
          caption: 'Assemble',
          subcaption: 'Steel poles through heavy-duty canvas',
        },
      ]
    : []),
  ...(media.process.deliver
    ? [
        {
          id: 'process-deliver',
          src: media.process.deliver,
          alt: 'Delivering beds',
          category: 'process' as const,
          location: undefined as string | undefined,
          community: undefined as string | undefined,
          caption: 'Deliver',
          subcaption: 'Beds reaching remote communities',
        },
      ]
    : []),
  // Community landscapes
  ...(media.community.tennantCreek
    ? [
        {
...
const categories: { id: Category; label: string; count: number }[] = [
  ...
  { id: 'people', label: 'People', count: allPhotos.filter((p) => p.category === 'people').length },
  { id: 'product', label: 'Product', count: allPhotos.filter((p) => p.category === 'product').length },
  { id: 'process', label: 'Process', count: allPhotos.filter((p) => p.category === 'process').length },
  { id: 'community', label: 'Community', count: allPhotos.filter((p) => p.category === 'community').length },
];
...
export default function GalleryPage() {
  ...
  const lightboxPhoto = allPhotos.find((p) => p.id === lightbox);
      ...
      <section className="relative bg-foreground text-background overflow-hidden">
        <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <CommunityMap
            ...
            storytellers={storytellerProfiles}
