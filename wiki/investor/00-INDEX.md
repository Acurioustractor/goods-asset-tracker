# Goods Investor Wiki — Master Index

> Purpose: the single careful pass over every thematic area of the pitch. Each area gets its
...
## Standing rules for every area doc
- Every figure carries a source + claims-status label (observed / requested / agreed / delivered / measured / modelled / proposed).
- Consent gate default-deny: held voices (Kununurra Elder, Walter) never appear. Quotes are registry-verbatim only.
- No banned words (co-design, empower, beneficiaries, ecosystem, scalable solution, transformational, journey, unlock). No em dashes.
- Ownership is a pathway, never claimed complete. scabies→RHD is the why, never a claimed outcome.
