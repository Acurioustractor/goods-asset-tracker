...
> Accessible source note for the ACT entity and governance facts used in the Goods pack. This translates the relevant ACT Tractorpedia source into reviewable Goods wiki material so readers are not asked to trust a hidden local file path.

## Source status

| Field | Status |
| --- | --- |
| Source type | ACT ecosystem source-of-truth note |
| Canonical source | [ACT Tractorpedia public viewer](https://act-global-infrastructure.vercel.app/tractorpedia.html), with the core facts source note last verified 25 April 2026 |
| Review status | Strong internal source, needs legal/accounting confirmation before external legal claims |
| Sensitivity | Internal. Do not publish ABNs, emails or banking details externally without review. |
| Owner | ACT founders and Standard Ledger for legal/accounting confirmation |
...
| Person / organisation | Role in ACT core facts | Goods relevance |
| --- | --- | --- |
| **Benjamin Knight** | Co-founder and director. | Founder accountability and build lead. |
| **Nicholas Marchesi OAM** | Co-founder and director. | Founder accountability, product vision and design direction. |
| **Standard Ledger** | Engaged accountant. | ABN, GST, BAS, R&D coordination and legal referral pathway. |
| **NAB** | Pty banking provider. | Company banking infrastructure. |
| **Oonchiumpa** | Indigenous community partner. | Mparntwe / Alice Springs production and community pathway. |
| **PICC** | Indigenous community partner. | Palm Island production and community pathway. |
| **BG Fit** | Indigenous community partner. | Mount Isa pathway. |
...
- [ACT Tractorpedia public viewer](https://act-global-infrastructure.vercel.app/tractorpedia.html), with the ACT core facts source note translated into this reviewable Goods source page. Last verified 25 April 2026.
- [[may-2026-founder-working-conversation]]
