...
> What's in place, what's draft, what's to-do. SEFA and QBE Stage 2 DD will drive adoption of several policies during 2026.
...
- **Board charter** (trigger: independent director recruitment).
- **Delegations of authority matrix** (trigger: board recruitment + SEFA covenant).
- **Director induction pack** (trigger: board recruitment).
