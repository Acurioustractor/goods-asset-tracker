...
Ben ruled on 5 September 2026, in his own words: "the charity has started, that is the charity, we
have directors, it's changing over, lock it."

The ruling as written:

> The Butterfly Movement Ltd, trading as Goods on Country, is the QBE Stage 2 applicant and
> recipient and the home of the work (ruling X). Its directors are Kristy Bloomfield, Audrey Deemal
> and Jeremy Donovan; the handover from the previous board is in progress and completes at the AGM.
> A Curious Tractor Pty Ltd is the cohort entrant and the related entity transferring its assets;
> Nicholas Marchesi, sole trader, is the historic trading vehicle whose books carry FY26.

The ruling also removed a set of hedges from every funder surface. "Subject to confirmation with
Social Impact Hub", "recommended route", "subject to Jay", "proposed applicant" and "grade B until
the ASIC extract" are gone. Jay is told the route. The ASIC and ACNC extracts are attachments for
Q4 and Q22 and never gates on saying who the directors are.

What ruling AA holds back is as useful as what it locks. The AGM has no date until the auditor
reports, which the board secretary said on 1 September. Full Indigenous directorship stays the
stated aim on the drawing. Ownership stays a pathway.

**Where the ruling lives.** This worktree's `DECISIONS.md` does not carry ruling AA. A search of
the file returns nothing, and the text above was read in the primary repo at
`/Users/benknight/Code/Goods Asset Register/DECISIONS.md`, under the heading "2026-09-05 and
2026-09-03: existing QBE rulings imported from the story worktree". Until the two logs are
reconciled, the primary repo is the decision log of record for ruling AA, and an agent working
here will not find it by reading the file in front of them.

## The four entities

| Entity | What it is | What it does for Goods |
|---|---|---|
| **The Butterfly Movement Ltd** (ABN 22 155 132 684) | Company limited by guarantee. ACNC-registered charity since 3 December 2012, DGR endorsed since 17 January 2012. Control transferring from TABOO Foundation. | Applicant and recipient under ruling AA. Holds the registered business name "Goods on Country" from 23 July 2026. The only DGR route: deductible gifts land here and nowhere else. |
| **A Curious Tractor Pty Ltd** (ACN 697 347 676, ABN 36 697 347 676) | The go-forward trading company, registered 21 April 2026. Holds no registered business names at all, checked on ABN Lookup 25 July 2026. | The QBE cohort entrant, and the related entity transferring its assets. Repayable finance sits here because Australian law puts it here: equity and loans to the company, deductible gifts to the DGR. |
| **Nicholas Marchesi, sole trader** (ABN 21 591 780 066) | The historic trading vehicle. Still the ledger Goods invoices out of. | Carries FY26. Goods-tagged receipts of $653,246 and 324 Goods-tagged bills worth $286,507 sit in this ledger, along with every settled bed invoice. |
| **A Kind Tractor Ltd** (ABN 73 669 029 341) | Company limited by guarantee. Dormant. Not DGR. | No Goods role. Do not name it as a vehicle or a DGR pathway. |

Two of those four are easy to conflate and the conflation has reached funder documents before.
"Goods on Country" is a business name of the charity. The company holds none. Beds are sold by the
...
|---|---|---|
| FY26 income | $77,080 | about $713,827 on the Goods carve-out |
| FY26 result | expenses $119,934, so EBITDA about negative $42,854, closing cash $4,041 | roughly $168,000 before founder wages |
...
signed stays off it. The roughly $168,000 is
recorded in the 12 September review of the real forms and has no signed set of accounts under it
yet, which is the same gap the accountant's letter is meant to close.
...
net. Facilitation is a second thing buyers already pay for, $50,000 net across ten visits billed at
...
Butterfly's constitution has not been located. It is recorded against Eloise. Four separate things
wait on it:

1. QBE question 12, which is blocked on the file itself, and question 22, which is owed a document.
2. Tim Fairfax field 4.1 on the FY27 Resilience form, which is required. TFFF also lists the
   constitution among fourteen required attachments, of which Goods holds three.
3. The 50% test that decides whether Goods is an Indigenous business. `ownership-problem.ts` states
   it plainly: the same 50% threshold gates Indigenous Business Australia finance, where it reads as
   ownership or membership, and for a company limited by guarantee the test is membership, which
   sits in Butterfly's constitution and has not been read.
4. IBA eligibility, which turns on that same membership clause.

Ruling J drew the line that must never blur. Aboriginal directors on the charity is not First
Nations ownership of the entity that sells. Supply Nation, the Indigenous Procurement Policy, IBA
and First Australians Capital all test the supplier, which is the company. Claiming the board
satisfies the supplier test in a funder document would end the relationship. Ownership is written
as a pathway on every surface.
...
| Current management cashflow and reconciled opening balances for the applicant | Eloise | QBE Q20 and Q21 |
| The shop's seller of record during the migration | Ben and Nic with MinterEllison | Retail sales through the company on the charity's domain |
| The AGM date | The auditor's report, board secretary, 1 September | The formal completion of the board handover |

## Why this one question reaches all three applications

QBE's Q2 asks five things in one field: which entity applies, how the related entities connect, how
funds flow, why the grant sits where it sits, and how capital raised elsewhere supports the
enterprise. Every one of those five is an entity answer.

Tim Fairfax invited Butterfly by name. Katie Norman wrote on 31 August, "invite The Butterfly
Movement to apply for a three-year grant of $300,000.00 in three equal payments", and the FY27
Resilience form tests governance more than it tests the model.

SEFA forces the question outright, and SEFA is the one that matters most this month. Jay's steer on
the QBE final application page is that corporate philanthropy is meant to unlock debt or equity this
year, and the $600,000 Goods has asked for is 100% philanthropy. The only debt line available is the
SEFA loan. A sensible first ask there is $50,000 to $100,000: the second press at $22,500 plus
...
[[investors/tim-fairfax]] · [[program/stage-2-funding]]
