...
These are the core product and production assets that should sit beside the strategy language. They show that the ambition is already physical: a real bed, a real washing-machine prototype, a real production setup, real QR infrastructure and real community testing.

<div class="wiki-media-grid">
  <figure>
    <img src="/images/product/stretch-bed-hero.jpg" alt="Stretch Bed assembled on Country with recycled plastic legs, galvanised steel poles and canvas surface" />
    <figcaption><strong>Stretch Bed product proof.</strong> The current flagship bed: recycled HDPE legs, galvanised steel poles and heavy-duty Australian canvas. Source: <a href="/insiders/products/stretch-bed">Stretch Bed</a> and <a href="/insiders/sources/canonical-product-data">canonical product data</a>.</figcaption>
  </figure>
  <figure>
    <img src="/images/product/stretch-bed-assembly.jpg" alt="Stretch Bed being assembled with canvas, poles and recycled plastic legs" />
    <figcaption><strong>Assembly proof.</strong> The bed is designed to pack flat, assemble quickly and be repaired in parts. Source: <a href="/insiders/products/stretch-bed">Stretch Bed</a>.</figcaption>
  </figure>
  <figure>
    <img src="/images/product/washing-machine-hero.jpg" alt="Pakkimjalki Kari washing-machine prototype with recycled plastic enclosure on red dirt" />
    <figcaption><strong>Washing-machine prototype.</strong> Pakkimjalki Kari is prototype only, not for direct sale. Source: <a href="/insiders/products/washing-machine">washing-machine page</a> and <a href="/insiders/sources/canonical-product-data">canonical product data</a>.</figcaption>
  </figure>
  <figure>
    <img src="/images/process/facility-full-site.jpg" alt="Containerised production facility with shipping containers open on site" />
    <figcaption><strong>Production facility proof.</strong> The two-container production setup is real infrastructure, not just a pitch line. Source: <a href="/insiders/products/plant-design">plant design</a> and <a href="/insiders/sources/production-facility-guide">production facility guide</a>.</figcaption>
  </figure>
  <figure>
    <img src="/images/process/cnc-router-full.jpg" alt="CNC router used to cut recycled plastic bed parts" />
    <figcaption><strong>Part-making proof.</strong> Pressed recycled-plastic sheets are cut into bed parts with CNC equipment. Source: <a href="/insiders/sources/production-facility-guide">production facility guide</a>.</figcaption>
  </figure>
  <figure>
    <img src="/images/pitch/bed-qr-code.jpg" alt="QR code label attached to a Goods bed" />
    <figcaption><strong>Asset-register proof.</strong> QR and product IDs support feedback, repair and lifecycle tracking. Source: <a href="/insiders/sources/qr-code-data">QR code data</a> and <a href="/insiders/sources/community-essential-goods-tracking-model">tracking model</a>.</figcaption>
  </figure>
</div>

Use the images above as reviewable proof for this page. Before using any people-identifiable image in an external pack, check the consent status and intended audience.

### Stretch Bed Product Proof

The canonical product is the Stretch Bed. The reviewable source page is [[../sources/canonical-product-data]], which translates the structured product data into human-readable facts.
...
<div class="wiki-media-strip">
  <figure>
    <img src="/images/pitch/bed-seq-3-all-parts.jpg" alt="Stretch Bed components laid out before assembly" />
    <figcaption>All parts visible before assembly: canvas, poles and recycled-plastic legs.</figcaption>
  </figure>
  <figure>
    <img src="/images/pitch/bed-seq-2-legs-pole.jpg" alt="Stretch Bed recycled plastic legs connected to a galvanised steel pole" />
    <figcaption>The leg and pole connection is simple enough to explain without a technical manual.</figcaption>
  </figure>
  <figure>
    <img src="/images/product/stretch-bed-in-use.jpg" alt="Stretch Bed in use in community setting" />
    <figcaption>Use-case proof: a washable bed built for movement, repair and repeated use.</figcaption>
  </figure>
</div>
...
<div class="wiki-media-strip">
  <figure>
    <img src="/images/product/washing-machine-installed.jpg" alt="Pakkimjalki Kari washing-machine prototype installed in community" />
    <figcaption>Installed prototype: useful evidence, but still prototype status only.</figcaption>
  </figure>
  <figure>
    <img src="/images/product/washing-machine-name.jpg" alt="Pakkimjalki Kari name on washing-machine enclosure" />
    <figcaption>Pakkimjalki Kari was named in Warumungu language by Elder Dianne Stokes.</figcaption>
  </figure>
  <figure>
    <img src="/images/media-pack/speed-queen-controls.jpg" alt="Speed Queen washing-machine controls being shown to a community member" />
    <figcaption>The base machine is commercial-grade Speed Queen. The design problem is durability plus affordability.</figcaption>
  </figure>
</div>

### On-Country Production Proof

The On-Country production system is not just a future claim. The reviewable source page is [[../sources/production-facility-guide]], and the Notion production HQ keeps the live human review and operating notes.
...
There is one production detail that needs human review before being repeated externally: the production guide source page records one sheet per bed, while the Notion StretchBed HQ page says "2 sheets per bed" and "3 beds per day." That difference should be reconciled by Nicholas, Defy Design or whoever owns the production bill of materials.

<div class="wiki-media-strip">
  <figure>
    <img src="/images/process/shredder-granulator.jpg" alt="Industrial plastic shredder in the containerised production setup" />
    <figcaption>Shredder and granulator: turning collected plastic into usable feedstock.</figcaption>
  </figure>
  <figure>
    <img src="/images/process/heat-press-full.jpg" alt="Heat press used to make recycled plastic sheets" />
    <figcaption>Heat press: shredded plastic becomes sheet material for bed parts.</figcaption>
  </figure>
  <figure>
    <img src="/images/process/pressed-sheets-stacked.jpg" alt="Pressed recycled plastic sheets stacked for production" />
    <figcaption>Pressed sheets stacked for cutting, assembly and quality checks.</figcaption>
  </figure>
  <figure>
    <img src="/images/process/cut-legs-stored.jpg" alt="Cut recycled plastic Stretch Bed legs stored for assembly" />
    <figcaption>Finished bed leg components ready for assembly and dispatch.</figcaption>
  </figure>
</div>
...
- [[../sources/qr-code-data]] records the QR and product-ID infrastructure.
- [[../sources/community-essential-goods-tracking-model]] explains the intended product lifecycle and support model.
- [[../sources/march-2026-compendium]] records the 389 tracked asset snapshot across 8+ communities.
- Individual raw bed and washing-machine records exist locally and need packaging before being sent to external reviewers.
...
|---|---|---|
| Tracked assets | 389 assets tracked across 8+ communities in the March 2026 compendium | [[../sources/march-2026-compendium]] |
| Centre Corp / Utopia | 107 beds approved in structured data, linked to Utopia Homelands pathway | [[../sources/march-2026-compendium]] and [[../sources/canonical-product-data]] |
| Named requests | Dianne Stokes 20 beds, Norman Frank 3 beds, Homeland Schools Company 65 beds, Utopia beds for children, PICC 40 beds discussed | [[../sources/march-2026-compendium]] |
| Large exploratory request | Groote Archipelago request for 500 mattresses and 300 washing machines | [[../sources/march-2026-compendium]] |
| Funding journey | About $460K confirmed received across six funders, with a larger active pipeline | [[../sources/funding-journey]] and [[../sources/grants-archive-index]] |
...
- Make every claim carry its evidence type: product spec, asset record, quote, photo, video, Notion record, grant trail or founder working note.
...
- production runs that do not rely on us being physically present for every step.
...
| Proof | Review location | What it shows |
|---|---|---|
| Canonical Stretch Bed specs | [[../sources/canonical-product-data]] and [[../products/stretch-bed]] | Product status, materials, dimensions, warranty and repairability claims |
| Brand and human voice | [[../sources/march-2026-compendium]] and [[../sources/community-voices-from-the-ground]] | Origin story, quotes, story cards and media pack captions |
| March 2026 compendium | [[../sources/march-2026-compendium]] | Deployment counts, partners, demand, funding, risks and media assets |
| Community voice source doc | [[../sources/community-voices-from-the-ground]] | Named community voices and themes |
| Production guide | [[../sources/production-facility-guide]] | Facility layout, equipment, process, safety and shift handover |
| Funding journey | [[../sources/funding-journey]] | Confirmed funders, active applications, misses and relationship map |
| Grant archive index | [[../sources/grants-archive-index]] | Source trail for funder documents and partner correspondence |
| Stretch Bed product images | [[../products/stretch-bed]] and [Stretch Bed shop page](/shop/stretch-bed-single) | Product in use and assembly |
| Community images | [Stories page](/stories), [process page](/process) and Goods media assets rendered throughout this pack | Human context and product testing |
| People images | [[../sources/community-voices-from-the-ground]] and rendered people/story pages | Named storyteller and partner context |
| Production images | [[../sources/production-facility-guide]], [process page](/process) and the recycling plant video | Plant and process proof |
| QR proof | [[../sources/qr-code-data]] and [[../sources/community-essential-goods-tracking-model]] | Asset tracking and product lifecycle spine |
| Local videos | [process page](/process), [stories page](/stories) and the Descript links below | Product, facility and community proof |
| Descript videos | [facility walkthrough](https://share.descript.com/view/haRZJbfJadJ), [Fred Campbell](https://share.descript.com/view/YQwAcYfxzkn), [Alice Springs voices](https://share.descript.com/view/LAT0KNJMxmH), [timelapse](https://share.descript.com/view/Xtrc5ZYsym6) | Facility walkthrough, Fred, Alice Springs recipient and timelapse |
| Notion Goods HQ | [Goods HQ](https://app.notion.com/p/177ebcf981cf805fb111f407079f9794) | Live operating hub, opportunity board and linked project pages |
| Notion production HQ | [On Country Production HQ](https://app.notion.com/p/1faebcf981cf80c49e54f7e6b190c37c) | Production equipment, phases, operating notes and facility proof |
| Notion videos and photos | [Goods videos and photos](https://app.notion.com/p/2faebcf981cf80eab263ca3a91659da1) | Public Descript and Google Photos links |

## What Not To Overclaim

These should stay out of external or partner-facing copy unless we have checked the source.
...
This is the review list for our Notion deep dive.
...
- [Goods HQ Notion](https://www.notion.so/acurioustractor/Goods-HQ-177ebcf981cf805fb111f407079f9794), fetched 2026-05-02.
