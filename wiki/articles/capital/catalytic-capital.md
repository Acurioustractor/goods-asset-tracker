...
> Capital that goes where no one else will, for the purpose of releasing other capital. Named for the chemistry analogy: a catalyst enables a reaction but is lost in the process.
...
- **Private foundations** via PRI (Program-Related Investments). See [[paf-puaf-dgr]] for how Australian PAFs and PuAFs can credit below-market rates as distributions.
- **Family foundations** with catalytic buckets (Mindaroo Foundation has one).
- **Corporate foundations** (QBE Foundation is doing exactly this by match-requiring repayable capital).
- **DFIs and CDFIs** internationally.
- **Recoverable-grant programs** (PFI, QLD Govt's new program).
