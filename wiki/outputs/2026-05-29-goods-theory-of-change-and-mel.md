...
- **A health-to-education-to-justice rationale exists, but it is a why, not a claimed outcome (claim ceiling, 2026-06-18).** The logic is that durable bedding and working washing machines support the conditions needed to interrupt known infection pathways, which is part of why a bed and a washer are health hardware. We do not claim Goods keeps children in school or out of the justice system: that "bed to courtroom" framing is an aspiration for why the work matters, never a stated result, and a justice or health outcome only leaves the future column when a partner evaluation method produces it, attributed to that partner. The rationale maps onto QBE's inclusion priority, but should be pitched as a hypothesis, not as evidence.
