...
ASKS = [
    ...
    ("Snow Foundation", "Grant", 100000, "=snow_beds", "To ask", "Ben, 10 Sep: an ask shaped like Brian M. Davis, counted as bed money. Snow was 57% of last year's receipts."),
...
CLAIMS = [
    ...
    ("Snow's share of those receipts", "$375,000, 57%", "Unverified", "Not traced to a cell. Needs the source before it goes to a funder."),
