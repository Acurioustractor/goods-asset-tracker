...
2. **Duplicate pages.** /about, /mission, /story, /story/road and /the-work serve the same 4,496-word page. /deck, /pitch/deck, /pitch/control-room and /pitch/road serve one old deck. /press and /media are the same page, as are /get-involved and /invest. Pick one of each and redirect the rest.
